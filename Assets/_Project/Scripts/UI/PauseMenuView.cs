...
{
    /// <summary>
    /// Pause menu (GDD §16). Dumb view: exposes Resume / Restart / Main Menu intents. The freeze itself is the
    /// state machine's Paused phase (<c>timeScale</c> + insert gate, T13); this view just surfaces the buttons.
    /// </summary>
